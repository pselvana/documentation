...
- [`legacy_permit_unsafe_log_operations`](../../reference/cluster-properties/#legacy_permit_unsafe_log_operations): Flag enabling a Redpanda cluster operator to use unsafe control characters within strings such as consumer group names or user names.
- [`legacy_unsafe_log_warning_interval_sec`](../../reference/cluster-properties/#legacy_unsafe_log_warning_interval_sec): Period at which to log a warning about using unsafe strings containing control characters.
